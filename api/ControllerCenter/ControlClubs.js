const ClubDetailsController = require("../Puppeteer/ClubDetails/GetClubDetails");
// DataCenter
const { DataCenterClubs } = require("../DataCenter/evaluateClubs");
const GetCompetitions = require("../ScrapeCenter/getCompetitions");

/*
    This is the Control Center for club data conditioning, scraping and Assigning
...
async function Controller_Club(FromSTRAPI) {
  ...
  module.exports = { Controller_Club };
