...
// Enhanced logging function to include more context
function logErrorWithContext(error, context) {
  ...
  // Adding this function to the logger object for easy access
  logger.logErrorWithContext = logErrorWithContext;
